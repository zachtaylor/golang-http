...
// HTTPReader is an interface for recognizing Sessions in http.Request
...
// HTTPWriter is an interface for writing Sessions to http.Writer
type HTTPWriter interface {
	// WriteHTTP writes the Set-Cookie header in http.Writer
